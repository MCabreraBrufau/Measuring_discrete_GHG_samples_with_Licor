#Headspace GHG functions

## Functions to calculate gas concentration in water using the headspace technique
## and headspace samples measured through gas chromatography/LICOR small sample analysis. 

#Author: Jorge Montes-Perez
#These functions are copied from the below repository, and copied here for consistency.
#Original repo: https://raw.githubusercontent.com/JorgeMonPe/Functions_headspace_calculation/main/Functions_gas_concentration.R 
